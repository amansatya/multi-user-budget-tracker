                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="mb-12 opacity-0 animate-[fadeIn_1s_ease-out_0.8s_forwards]">
                            <button
                                ...
                                className="group bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white dark:bg-blue-700 dark:hover:bg-blue-800 font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl dark:shadow-lg inline-flex items-center"
                            >
                                Get Started Now
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 opacity-0 animate-[fadeIn_1s_ease-out_1s_forwards]">
                            {[
                                ...
                                <div
                                    key={idx}
                                    className={`flex flex-col items-center p-8 bg-white/70 dark:bg-gray-800/50 backdrop-blur-lg rounded-2xl border-2 ${feature.border} transition-all duration-300 hover:scale-105 hover:-translate-y-2 shadow-md`}
                                >

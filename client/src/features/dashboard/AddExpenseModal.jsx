...
const AddExpenseModal = ({ isOpen, onClose, onAddExpense }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-gradient-to-br from-indigo-900/60 via-purple-800/50 to-pink-700/40 dark:from-slate-900/80 dark:via-gray-800/70 dark:to-zinc-900/60 backdrop-blur-sm pt-[69px] pb-[5px]">
            ...
            <div className="h-full overflow-y-auto flex justify-center p-4 scrollbar-custom">
                            ...
                            <label className="flex items-center space-x-3 cursor-pointer group">
                                <div className="relative">
                                    ...
                                    <div className={`w-11 h-6 rounded-full border transition-all duration-300 ${
                                        ...
                                        <div className={`absolute w-4 h-4 rounded-full shadow-sm transform transition-all duration-300 top-1 ${
                                            isRecurring ? 'translate-x-5 bg-gradient-to-br from-blue-500 to-indigo-600' : 'translate-x-1 bg-gray-400 dark:bg-gray-500'
                                        }`}></div>
                                    </div>
                                </div>
